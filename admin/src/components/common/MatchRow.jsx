...
export default function MatchRow({ match, showCompetition = true, className }) {
  ...
  return (
    <Link
      ...
      className={cn('group block rounded-xl px-3 py-3 transition-colors hover:bg-surface-2 focus-visible:bg-surface-2 sm:px-4', className)}
    >
