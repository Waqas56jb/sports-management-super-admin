...
import { AlertCircle, Clock, Lock, Mail, ShieldCheck, Shirt } from 'lucide-react';
      ...
      <div className="animate-slide-up">
        ...
        <form ref={form.formRef} onSubmit={form.handleSubmit} noValidate className="mt-7 space-y-5">
          ...
          <div className="flex flex-wrap items-center justify-between gap-x-3 gap-y-0">
            ...
            <Link to="/player/forgot-password" className="inline-flex min-h-10 items-center text-sm font-semibold text-brand-700 hover:underline dark:text-brand-300 sm:min-h-0">
              {t('auth.forgot')}
            </Link>
          </div>
