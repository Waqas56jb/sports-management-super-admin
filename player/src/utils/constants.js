...
export const MY_ATTENDANCE_STATUSES = ['present', 'absent', 'late', 'excused', 'pending'];
...
export const NOTIFICATION_CATEGORIES = ['all', 'unread', 'matches', 'training', 'team', 'system'];
export const MATCH_TYPES = ['league', 'cup', 'tournament', 'friendly'];
