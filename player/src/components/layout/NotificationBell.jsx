...
export default function NotificationBell() {
  ...
  const openItem = async (n) => {
    ...
    navigate(n.link || '/player/notifications');
  };
    ...
    <div ref={wrapRef} className="relative">
      ...
      {open && (
        ...
        >
          ...
          <Link to="/player/notifications" onClick={() => setOpen(false)} className="block border-t border-line py-3 text-center text-sm font-medium text-brand-700 hover:bg-surface-2 dark:text-brand-300">
