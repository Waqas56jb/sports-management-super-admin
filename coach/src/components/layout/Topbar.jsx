  ...
  return (
    <header className="glass safe-top sticky top-0 z-30 border-b border-line/70 no-print">
      <div className="flex h-14 items-center gap-2 px-3 sm:h-16 sm:gap-3 sm:px-6">
        ...
        <Link to="/coach/dashboard" className="flex min-w-0 flex-1 items-center md:hidden" aria-label={t('nav.dashboard')}>
        ...
        <div className="flex items-center gap-0.5 sm:gap-1">
          ...
          <Dropdown
            ...
            items={[
              { label: t('nav.myProfile'), icon: UserRound, to: '/coach/profile' },
              { label: t('nav.settings'), icon: Settings, to: '/coach/settings' },
